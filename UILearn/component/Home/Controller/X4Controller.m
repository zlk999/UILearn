...
- (void)imgSetting {
    ...
    img.image = [UIImage imageNamed:@"img04"];
...
- (void)creatButton {
    self.btn = [[UIButton alloc] initWithFrame:CGRectMake(200, 660, 100, 40)];
//    btn.center = CGPointMake(Device_Width * 0.5, Device_Height * 0.5);
    [self.btn setTitle:@"前往副页5" forState:UIControlStateNormal];
