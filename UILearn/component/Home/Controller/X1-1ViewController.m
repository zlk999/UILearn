...
@interface X1_1ViewController ()
@property(nonatomic,strong) UIButton *btn;
@end

@implementation X1_1ViewController

- (void)viewDidLoad {

    self.navigationItem.title = @"副页1";
    [super viewDidLoad];
...
- (void)imgSetting {
    ...
    img.image = [UIImage imageNamed:@"img01"];
...
//    btn.center = CGPointMake(Device_Width * 0.5, Device_Height * 0.5);
    [self.btn setTitle:@"前往副页2" forState:UIControlStateNormal];
